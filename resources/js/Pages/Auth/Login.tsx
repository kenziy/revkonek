        ...
        <GuestLayout>
            ...
            <div className="text-center mb-6">
                ...
                <p className="text-sm text-secondary-500 dark:text-secondary-400 mt-1">
                    Sign in to continue to REV KONEK
                </p>
            </div>
            ...
            <form onSubmit={submit} className="space-y-5">
                ...
                <div className="flex items-center">
                    ...
                    <label
                        htmlFor="remember"
                        className="ml-2 text-sm text-secondary-600 dark:text-secondary-400 cursor-pointer"
                    >
                        Remember me
                    </label>
                </div>
                ...
                <div className="relative my-6">
                    ...
                    <div className="relative flex justify-center text-sm">
                        <span className="bg-white dark:bg-secondary-800 px-4 text-secondary-500">
                            or continue with
                        </span>
                    </div>
                </div>
